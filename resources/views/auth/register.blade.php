                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control" name="role" id="role" onchange="changeRole()">
                                        <option value="sender" @if(request('role') == 'sender') selected @endif>Người bán</option>
                                        <option value="receiver" @if(request('role') == 'receiver') selected @endif>Khach hang</option>
                                    </select>
                                </div>
                                {{--<div class="form-group col-6">--}}
